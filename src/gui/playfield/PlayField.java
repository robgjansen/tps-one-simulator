...
public class PlayField extends JPanel {
	...
	public void setUnderlayImage(BufferedImage image, double dx, double dy,
		...
		curTransform.scale(PlayFieldGraphic.getScale(), PlayFieldGraphic
				.getScale());
	...
	public Coord getGraphicsPosition(Coord loc) {
		Coord c = loc.clone();
		c.setLocation(PlayFieldGraphic.scale(c.getX()), PlayFieldGraphic
				.scale(c.getY()));
		return c;
	}
	...
	public Coord getWorldPosition(Coord loc) {
		Coord c = loc.clone();
		c.setLocation(PlayFieldGraphic.invScale(c.getX()), PlayFieldGraphic
				.invScale(c.getY()));
		return c;
	}
