...
/**
 * Queue of external events. This class also takes care of buffering the events
 * and preloading only a proper amount of them.
 */
public class ExternalEventsQueue implements EventQueue {
	 ...
	 * 
	 * @param filePath
	 *            Path to the file where the events are read from. If file ends
	 *            with extension defined in
	 *            {@link BinaryEventsReader#BINARY_EXT} the file is assumed to
	 *            be a binary file.
	 * @param nrofPreload
	...
	/**
	 * Returns the amount of events left in the buffer at the moment (the amount
	 * can increase later if more events are read).
	 * 
