...
/**
 * Event queue where simulation objects can request an update to happen at the
 * specified simulation time. Multiple updates at the same time are merged to a
 * single update.
 */
public class ScheduledUpdatesQueue implements EventQueue {
	...
	/**
	 * Returns the next scheduled event or event with time Double.MAX_VALUE if
	 * there aren't any.
	 * 
