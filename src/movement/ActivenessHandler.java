...
/**
 * Object of this class tell the movement models when a node belonging to a
 * certain group is active and when not.
 */
public class ActivenessHandler {
	/**
	 * Active times -setting id ({@value} ).<BR>
	 * Syntax: <CODE>start, end</CODE><BR>
	 * Multiple times can be concatenated by repeating the sequence. Time limits
	 * should be in order and should not overlap.
	 */
