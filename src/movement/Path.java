...
public class Path {
	...
	/**
	 * Copy constructor. Creates a copy of this path with a shallow copy of the
	...
	/**
	 * Sets a constant speed for the whole path. Any previously set speed(s) is
	 * discarded.
	 */
	...
	public Coord getNextWaypoint() {
		assert hasNext() : "Path didn't have " + (nextWpIndex + 1)
				+ ". waypoint";
