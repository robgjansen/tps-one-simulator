...
public class MaxPropRouterTest extends AbstractRouterTest {
	...
	protected void setUp() throws Exception {
		...
		ts.putSetting(
				SimScenario.SCENARIO_NS + "." + SimScenario.NROF_GROUPS_S, "1");
	...
	public void testCostValues() {
		...
		assertEquals(1 - (((1 + (1 + 0.5) / 2) / 2) / 2) / 2, r1
				.getCost(h1, h3));
	...
	public void testRouting() {
		...
		disconnect(h4);
		/*
		 * h4 probs: h3:0.25, th1:0.1875, h5:0.5625 these changes should not be
		 * visible to h3!
		 */
		Message m1 = new Message(h1, h5, msgId1, msgSize);
		h1.createNewMessage(m1);
	...
	/**
	 * Tests that more recent meeting probability sets replace older ones but
	 * not vice versa.
	 */
	public void testMpsTimeStamps() {
		...
		disconnect(h1);
		/*
		 * h1''': h2:0.25, h3:0.25, h4:0.5; h2:h2', h3:h3', h4:h4' h4': h1:1.0;
		 * h1:h1''', h2:h2', h3:h3'
		 */
		...
		disconnect(h2);
		/*
		 * h2'': h1:0.5, h3:0.5; h1:h1'', h3:h3'' (both from h3) h3'': h1:0.5,
		 * h2:0.5; h1:h1'', h2:h2'' (h1's probs should remain)
		 */
		...
		disconnect(h1);
		/*
		 * h1'''': h2:0.625, h3:0.125, h4:0.25; h2:h2''', h3:h3'', h4:h4' h2''':
		 * h1:0.75, h3:0.25; h1:h1'''', h2:h3'', h4:h4'
		 */
