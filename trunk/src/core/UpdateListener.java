 ...
 * to the World object. <BR>
 * <b>NOTE:</b> if update interval is large (if, e.g., no movement or connection
 * simulation is needed), update listeners may not get called at all during the
 * simulation.
 */
