...
public class EventLogControlPanel extends JPanel implements ActionListener {
	...
	public EventLogControlPanel() {
		...
		this.setBorder(BorderFactory
				.createTitledBorder(getBorder(), TITLE_TEXT));
	...
	/**
	 * Adds a new filter&pause control with initially "show" checked but "pause"
	 * unchecked
	 * 
	 * @param name
	 *            Name of the control
	...
	/**
	 * Adds a new heading in the control panel. Subsequent addControl controls
	 * will be under this heading
	 * 
	 * @param name
	 *            The heading text
	 */
