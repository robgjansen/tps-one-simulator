...
/**
 * External event for all the stages of relaying a message between two hosts
 * (start and possible abort or delivery).
 */
public class MessageRelayEvent extends MessageEvent {
	...
	public static final String[] STAGE_STRINGS = { "SENDING", "TRANSFERRED",
			"ABORTED" };
