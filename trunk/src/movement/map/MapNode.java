...
public class MapNode implements Comparable<MapNode> {
	 ...
	 * 
	 * @param type
	 *            The type (integer from range [{@value MIN_TYPE}, {@value
	 *            MAX_TYPE}])
	 ...
	 * 
	 * @param types
	 *            The types to check (array of values in range [{@value
	 *            MIN_TYPE}, {@value MAX_TYPE}])
	...
	private int typeToBitMask(int type) {
		assert type >= MIN_TYPE && type <= MAX_TYPE : "Invalid node type "
				+ type;
