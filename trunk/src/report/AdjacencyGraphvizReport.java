...
/**
 * Generates Graphviz compatible graph from connections. Connections that happen
 * during the warm up period are ignored.
 */
public class AdjacencyGraphvizReport extends Report implements
		ConnectionListener {
	...
	public void hostsConnected(DTNHost host1, DTNHost host2) {
		...
		if (ci == null) {
			cons.put(host1 + HOST_DELIM + host2, new ConnectionInfo(host1,
					host2));
		} else {
			ci.nrofConnections++;
		}
	...
	/**
	 * Private class stores information of the connected hosts and nrof times
	 * they have connected.
	 */
