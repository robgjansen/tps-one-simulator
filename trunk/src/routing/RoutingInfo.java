...
/**
 * Class for storing routing related information in a tree form for user
 * interface(s).
 */
public class RoutingInfo {
	...
	/**
	 * Creates a routing info based on any object. Object's toString() method's
	 * output is used as the info text.
	 * 
	 * @param o
	 ...
	 * 
	 * @return The children of this info or an empty list if this info doesn't
	 *         have any children.
	 */
